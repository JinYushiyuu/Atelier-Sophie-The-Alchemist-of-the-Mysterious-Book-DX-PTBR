...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	switch(pcOwn.getState()) {
		...
		case Enum.STATE_MOVE_IN:
		{
			...
			pcOwn.setMotionTag(s32MotionTag, 0, Val.MOTION_BLEND_FRAME, of32MotionSpeed, false, false);
		...
		case Enum.STATE_MOVE:
			if (pcOwn.isEndMotin()) {
				...
				pcOwn.setMotionTag(s32MotionTag, 1, Val.MOTION_BLEND_FRAME, of32MotionSpeed, true, false);
		...
		case Enum.STATE_MOVE_OUT:
		{
			...
			pcOwn.setMotionTag(s32MotionTag, 2, Val.MOTION_BLEND_FRAME, of32MotionSpeed, false, false);
