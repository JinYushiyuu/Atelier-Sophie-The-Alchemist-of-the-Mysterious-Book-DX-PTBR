...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	local as32StatePattern = [ 
		Enum.STATE_PATTERN0, Enum.STATE_PATTERN1, Enum.STATE_PATTERN3,
	]; // 逃げる、突貫１、シカト
	...
	switch(pcOwn.getState()) {
		...
		case Enum.STATE_EX12:
			...
			// 歩きモーション戻り
			//pcOwn.setMotionTag(MOTION_B_RUN, 2, Val.MOTION_BLEND_FRAME, of32WalkMotionSpeed, false, false);
