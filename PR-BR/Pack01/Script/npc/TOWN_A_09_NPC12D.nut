...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	local as32CommandArray = [
		...
		Enum.POS_MOVE_NPC_EX, 5870.0 ,0.0 , 11700.0, MOTION_WALK, fMoveSpeed,
		Enum.ENABLE_MAP_SYMBOL, true,
		Enum.POS_MOVE_NPC_EX, 5876.0 ,0.0 , 12314.0, MOTION_WALK, fMoveSpeed,		
		Enum.POS_MOVE_NPC_EX, 5348.4 ,0.0 , 16471.0, MOTION_WALK, fMoveSpeed,
		
		Enum.POS_MOVE_NPC_EX, 7148.7 ,0.0 , 18030.0, MOTION_WALK, fMoveSpeed,
		Enum.POS_MOVE_NPC_EX, 10449.4 ,0.0 , 18094.4, MOTION_WALK, fMoveSpeed,
		
		Enum.POS_MOVE_NPC_EX, 11262.0 ,0.0 , 18209.0, MOTION_WALK, fMoveSpeed,
		Enum.ENABLE_MAP_SYMBOL, false,
		Enum.POS_MOVE_NPC_EX, 12830.0 ,0.0 , 18466.0, MOTION_WALK, fMoveSpeed,
		Enum.FADE_OUT_NPC, 
		Enum.WAIT_NPC, 300.0,
