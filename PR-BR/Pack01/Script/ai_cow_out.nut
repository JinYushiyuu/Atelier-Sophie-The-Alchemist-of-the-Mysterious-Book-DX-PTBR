...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	local as32StatePattern = [ 
		Enum.STATE_PATTERN0, Enum.STATE_PATTERN1, Enum.STATE_PATTERN2, Enum.STATE_PATTERN2,
	]; // 吠える１、吠える２、歩く、走る
	
	// 歩くときの速度倍率とモーションスピード
	const of32WalkSpeed = 0.5;
	const of32WalkMotionSpeed = 2.0;
	
	// 走るときの速度倍率とモーションスピード
	const of32RunSpeed = 1.0;
	...
	switch(pcOwn.getState()) {
		...
		case Enum.STATE_WAIT:
			...
			// 待機モーションの発行
			pcOwn.setMotionTag(MOTION_F_WAIT, 0, 0.45, Val.MOTION_SPEED, true, false);
