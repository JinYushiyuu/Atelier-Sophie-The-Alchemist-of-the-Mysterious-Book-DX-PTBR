...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	switch(pcOwn.getState()) {
		...
		case Enum.STATE_WAIT:
			...
			// 待機モーションの発行
			pcOwn.setMotionTag(MOTION_F_WAIT, 0, 0.4, Val.MOTION_SPEED, true, true);
		...
		case Enum.STATE_EX0:
			...
			if (!pcOwn.isMaxRangeIn(pcPlayer.getPosition())) {
				...
				// 走りモーション入り
				pcOwn.setMotionTag(MOTION_B_RUN, 0, 0.3, of32EscapeMotionSpeed, false, false);
		...
		case Enum.STATE_EX1:
			if (pcOwn.isEndMotin()) {
				...
				// 走りモーション
				pcOwn.setMotionTag(MOTION_B_RUN, 1, Val.MOTION_BLEND_FRAME, of32EscapeMotionSpeed, true, false);
		...
		case Enum.STATE_EX3:
		{
			...
			// 走りモーション戻り
			pcOwn.setMotionTag(MOTION_B_RUN, 2, Val.MOTION_BLEND_FRAME, of32EscapeMotionSpeed, false, false);
		...
		case Enum.STATE_EX8:
			if (pcOwn.isEndMotin()) {
				pcOwn.setMotionTag(MOTION_EX8, 1, 0.4, Val.MOTION_SPEED, false, false);
		...
		case Enum.STATE_EX9:
			if (pcOwn.isEndMotin()) {
				...
				// 歩きモーション入り
				pcOwn.setMotionTag(MOTION_B_RUN, 0, 0.3, of32WalkMotionSpeed, false, false);
		...
		case Enum.STATE_EX10:
			if (pcOwn.isEndMotin()) {
				...
				// モーションを歩きに
				pcOwn.setMotionTag(MOTION_B_RUN, 1, 0.3, of32WalkMotionSpeed, true, false);
		...
		case Enum.STATE_EX14:
		{
			...
			pcOwn.setMotionTag(MOTION_EX9, 0, 0.3, Val.MOTION_SPEED, false, false);
		...
		case Enum.STATE_EX15:
			if (pcOwn.isEndMotin()) {
				...
				// 走りモーション入り
				pcOwn.setMotionTag(MOTION_B_RUN, 0, 0.3, of32RunMotionSpeed, false, false);
		...
		case Enum.STATE_EX16:
			if (pcOwn.isEndMotin()) {
				...
				// モーションを走りに
				pcOwn.setMotionTag(MOTION_B_RUN, 1, 0.3, of32RunMotionSpeed, true, false);
		...
		case Enum.STATE_EX20:
		{
			...
			pcOwn.setMotionTag(MOTION_F_WAIT, 0, Val.MOTION_BLEND_FRAME, Val.MOTION_SPEED, false, false);
		...
		case Enum.STATE_EX21:
			if (pcOwn.isEndMotin()) {
				pcOwn.setMotionTag(MOTION_F_WAIT, 1, Val.MOTION_BLEND_FRAME, Val.MOTION_SPEED, false, false);
