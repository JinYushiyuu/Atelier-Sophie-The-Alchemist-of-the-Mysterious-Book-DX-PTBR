...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	// 歩くときの速度倍率とモーションスピード
	const of32WalkSpeed = 0.9;
	const of32WalkMotionSpeed = 1.0;
	
	// 走るときの速度倍率とモーションスピード
	const of32RunSpeed = 2.0;
	const of32RunMotionSpeed  = 0.9;
	...
	switch(pcOwn.getState()) {
		...
		case Enum.STATE_WAIT:
			...
			// 待機モーションの発行
			pcOwn.setMotionTag(MOTION_WAIT, 0, 0.4, Val.MOTION_SPEED, true, true);
		...
		case Enum.STATE_EX0:
			// モーション発行
			pcOwn.setMotionTag(MOTION_EX9, 0, 0.4, Val.MOTION_SPEED, false, false);
		...
		case Enum.STATE_EX2:
			// モーション発行
			pcOwn.setMotionTag(MOTION_EX8, 0, 0.4, Val.MOTION_SPEED, false, false);
			pcOwn.setState(Enum.STATE_EX3);
		break;
		case Enum.STATE_EX3:
			if (pcOwn.isEndMotin()) {
				pcOwn.setMotionTag(MOTION_EX8, 1, 0.1, Val.MOTION_SPEED, false, false);
