...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	switch(pcOwn.getState()) {
		...
		case Enum.STATE_WAIT:
			...
			// 待機モーションの発行
			pcOwn.setMotionTag(MOTION_F_WAIT, 0, Val.MOTION_BLEND_FRAME, Val.MOTION_SPEED * of32RunMotionSpeed, true, true);
		...
		case Enum.STATE_MOVE_IN:
			...
			if (pcOwn.isMovePosition()) {
				...
				// 入りモーション
				pcOwn.setMotionTag(MOTION_RUN, 0, Val.MOTION_BLEND_FRAME, Val.MOTION_SPEED * of32RunMotionSpeed, false, false);
		...
		case Enum.STATE_MOVE_OUT:
			...
			// 戻りモーション
			pcOwn.setMotionTag(MOTION_RUN, 2, Val.MOTION_BLEND_FRAME, Val.MOTION_SPEED, false, false);
