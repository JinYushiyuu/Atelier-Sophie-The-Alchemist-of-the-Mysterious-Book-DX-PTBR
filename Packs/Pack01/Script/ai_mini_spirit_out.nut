...
//┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏┏
{
	...
	local as32StatePattern = [ 
		Enum.STATE_PATTERN0, Enum.STATE_PATTERN1, Enum.STATE_PATTERN3, Enum.STATE_PATTERN3,
	]; // 踊る、じたばた、歩く、走る
	...
	switch(pcOwn.getState()) {
		...
		case Enum.STATE_MOVE_IN:
		{
			...
			pcOwn.setMotionTag(s32MotionTag, 0, 0.3, f32MotionSpeed, false, false);
		...
		case Enum.STATE_MOVE:
			if (pcOwn.isEndMotin()) {
				...
				pcOwn.setMotionTag(s32MotionTag, 1, 0.3, f32MotionSpeed, true, false);
		...
		case Enum.STATE_MOVE_OUT:
		{
			...
			pcOwn.setMotionTag(s32MotionTag, 2, 0.3, f32MotionSpeed, false, false);
		...
		case Enum.STATE_EX0:
			// モーション発行
			pcOwn.setMotionTag(MOTION_F_WAIT, 0, 0.3, Val.MOTION_SPEED, false, false);
		...
		case Enum.STATE_EX3:
			if (pcOwn.isEndMotin()) {
				pcOwn.setMotionTag(MOTION_F_WAIT, 1, 0.3, Val.MOTION_SPEED, false, false);
